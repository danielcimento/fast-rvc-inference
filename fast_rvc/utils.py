...
def load_embedding(embedder_model, custom_embedder=None, models_root=None):
    if models_root is None:
        models_root = os.path.join(os.path.expanduser("~"), ".cache", "fast-rvc-inference")
    
    embedder_root = os.path.join(models_root, "rvc", "models", "embedders")
    embedding_list = {
